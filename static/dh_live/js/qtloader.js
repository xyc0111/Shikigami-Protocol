// ---------------------------------------------------------------------------
// 来源：DH_live/web_demo/static/js/MiniMateLoader.js（Qt for WebAssembly loader）
// 改动：仅移除页面级自动启动逻辑（DOMContentLoaded → init() → newVideoTask()），
//       改为由宿主（dh_live_bridge.js）显式调用 qtLoad() 后再执行 newVideoTask()，
//       以便宿主先设置 CONFIG.baseDir / 形象路径。qtLoad() 本体保持原样。
// ---------------------------------------------------------------------------
